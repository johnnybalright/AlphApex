...
G_PARENT_DIR = Path(__file__).parents[2]
...
LOG_DIR = G_PARENT_DIR / "output/logs"
INPUT_DIR = PARENT_DIR / "inputs"
TMP_DIR = G_PARENT_DIR / "output/tmp"
TEMPLATE_DIR = G_PARENT_DIR / "docs/templates"
CADD_DIR = BASE_DIR / "Cadd"
RESULT_DIR = G_PARENT_DIR / "output"
CONFIG_DIR = PARENT_DIR / "dirs_configs"
