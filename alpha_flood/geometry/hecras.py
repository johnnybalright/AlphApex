import sys
sys.path.append("/home/jpournelle/python_projects/plabz/river_division/main/configs")
import csv
import setproctitle
import os
import os.path
...
def hecras_calc(
    ...
    """
    try:
        setproctitle.setproctitle('alpha_hecras')
        if gs_1 is None:
            logger.debug("gs_1=None hecras_calc killed")
            return None
